...
public class DruidPooledStatement extends PoolableWrapper implements Statement {
    ...
    public final ResultSet executeQuery(String sql) throws SQLException {
        ...
        System.out.println("DruidPooledStatement=================================================");
    ...
    public final int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        System.out.println("DruidPooledStatement=====================================================");
        System.out.println(formatter.format(sql));
        System.out.println("autoGeneratedKeys="+autoGeneratedKeys);
        System.out.println("=====================================================================");
        incrementExecuteCount();
        transactionRecord(sql);
    ...
    public final int executeUpdate(String sql, int columnIndexes[]) throws SQLException {
        ...
        System.out.println("DruidPooledStatement=====================================================");
        System.out.println(formatter.format(sql));
        System.out.println("columnIndexes="+Arrays.asList(columnIndexes));
        System.out.println("=====================================================================");
        incrementExecuteCount();
        transactionRecord(sql);
