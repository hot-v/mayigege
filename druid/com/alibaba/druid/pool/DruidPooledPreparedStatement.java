...
public class DruidPooledPreparedStatement extends DruidPooledStatement implements PreparedStatement {
    ...
    FormatterSQL formatter = new FormatterSQL();
    ...
    public ResultSet executeQuery() throws SQLException {
        ...
        System.out.println("DruidPooledPreparedStatement==========================================");
        System.out.println(formatter.format(sql));
        if(params.size() != 0) {
        System.out.println("---------------------------------------------------------------------");
        for(int i = 1;i<=params.size();i++){
            if (params.get(i) != null && (params.get(i) instanceof String ||params.get(i) instanceof Date))
            {
    ...
    protected void oracleSetRowPrefetch() throws SQLException {
        if (!this.conn.isOracle()) {
          ...
          {
            if (fetchRowPeak > this.holder.getDefaultRowPrefetch()) {
