...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_{thisID}" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" style="font-size:12px; line-height:1.4;border-collapse: collapse;">\
    <tr id="_Draghandle_{thisID}" onselectstart="return false;" style="-moz-user-select: -moz-none; ' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" class="dialog_lt"><div style="width: 13px;"></div></td>\
      <td height="33" class="dialog_ct" ><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><input type="button" class="icon_dialog"/><span id="_Title_{thisID}">' + this.Title + '</span></div>\
       <div id="_ButtonClose_{thisID}" onclick="fixProgress();Dialog.getInstance(\'{thisID}\').cancelButton.onclick.apply(Dialog.getInstance(\'{thisID}\').cancelButton,[]);" title="关闭" class="dialog_closebtn" onmouseout="this.className=\'dialog_closebtn\'" onmouseover="this.className=\'dialog_closebtn_over\'" style="margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 17px; width: 28px; ' + (ielt7 ? "margin-top: 3px;" : "") + (this.ShowCloseButton ? "" : "display:none;") + '"></div><div id="_ButtonMax_{thisID}" onclick="Dialog.getInstance(\'{thisID}\').max()" title="最大化" class="dialog_maxbtn"  style="margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 17px; width: 28px; ' + (ielt7 ? "margin-top: 3px;" : "") + (this.ShowMaxButton ? "" : "display:none;") + '"></div><div id="_ButtonMin_{thisID}" onclick="Dialog.getInstance(\'{thisID}\').min()" title="最小化" class="dialog_minbtn"  style="margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 17px; width: 28px; ' + (ielt7 ? "margin-top: 3px;" : "") + (this.ShowMinButton ? "" : "display:none;") + '"></div>\
      </td>\
      <td width="13" height="33" class="dialog_rt"><div style="width: 13px;"><a id="_forTab_{thisID}" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" class="dialog_mlm"></td>\
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          ...
          <tr>\
            <td valign="top"><div id="_Container_{thisID}" style="text-align:left;background-color: rgb(246, 246, 246);position: relative; width: ' + this.Width + 'px; height: ' + this.Height + 'px;">\
        ...
        return "";
          ...
          <tr id="_ButtonRow_{thisID}" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_{thisID}" style="text-align:' + this.ButtonAlign + '; border-top: 1px solid #DADEE5; padding: 8px 20px;background-color:#f6f6f6;">\
                <input type="button" class="button btn btn-xs btn-success" style="' + (this.ShowOkButton ? "" : "display:none") + '"  value="' + this.OkButtonText + '" id="_ButtonOK_{thisID}"/>\
                <input type="button" class="button btn btn-xs btn-danger " style="' + (this.ShowCancelButton ? "" : "display:none") + '"  value="' + this.CancelButtonText + '" onclick="Dialog.getInstance(\'{thisID}\').close();" id="_ButtonCancel_{thisID}"/>\
              </div></td>\
          </tr>\
        </table></td>\
      <td width="13" class="dialog_mrm"></td>\
    </tr>\
    <tr>\
      <td width="13" height="13" class="dialog_lb"></td>\
      <td class="dialog_cb"></td>\
      <td width="13" height="13" class="dialog_rb"><a onfocus=\'$id("_forTab_{thisID}").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
';
...
';
		...
		html ='\
  <table><tr><td><div class="dialog_shadow_content"><table id="_DialogTable_{thisID}" width="' + (this.Width ) + '" cellspacing="0" cellpadding="0" border="0" style="font-size:12px; line-height:1.4;border-collapse: collapse;">\
    <tr id="_Draghandle_{thisID}" onselectstart="return false;" style="-moz-user-select: -moz-none; ' + (this.Drag ? "cursor: move;" : "") + '">\
  ...
  //如果已经最大化，则还原
   if(this.maxFlag==true){
	...
	//最大化
		...
		topWin.$id("_DialogTable_" + this.ID).width = bgDivWidth;
        topWin.$id("_Container_" + this.ID).style.width =  bgDivWidth-26 + "px";
...
Dialog.prototype.min = function () {
   ...
   //最小化
   	...
   	topWin.$id("_DialogTable_" + this.ID).width = 200 + 26;
...
Dialog.alert = function (msg, func, w, h,autoClose) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><input type="button" id="Icon_' + this.ID + '" class="icon_alert" align="absmiddle"></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:9pt">' + msgArray[0] + '</td></tr>\
	</table>';
    diag.show();
