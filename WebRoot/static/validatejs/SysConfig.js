var saveSysConfigConfig = {
	desc:[{rule:notBlank,msg:"描述 不能为空"},{rule:length,params:{min:0,max:200},msg:"描述 长度不在0-200范围"}],
	keyname:[{rule:notBlank,msg:"变量名 不能为空"},{rule:length,params:{min:0,max:65535},msg:"变量名 长度不在0-65535范围"}],
