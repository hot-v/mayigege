	...
	<div class="row">
		...
		<div class="box-body">
		 <#if entity?exists>
		 	...
		 	<div class="form-group">
				<label for="form-field-1" class="col-md-3 control-label no-padding-right"> 资源名 </label>
				<div class="col-md-6">
				    <input type="text" name="resource" value="${(entity.resource)!}"  class="form-control" disabled />
		 		</div>
			 </div>	
		 <#else>
