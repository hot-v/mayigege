				...
				<div class="box box-primary">
					<div class="box-body">
								...
								<select id="categroyId" name="categroyId" val="${(entity.categroyId)!}" class="form-control select2" onchange="clearErrMsg(this)">
									...
									<#if (serviceList)?exists && ((serviceList)?size != 0)>
										<#list serviceList as categroy>
											<option value="${categroy.id!}">${categroy.serviceName!}</option>
										</#list>
									</#if>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
							    <input type="text" id="startTime" name="startTime" value="${(entity.startTime)!}" class="form-control dateCalendar" readonly />
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
							    <input type="text" id="endTime" name="endTime" value="${(entity.endTime)!}" class="form-control dateCalendar" readonly />
							</div>
