				...
				<div class="box box-primary">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
							    <input type="text" id="username" name="username" value="${(entity.username)!}" class="form-control" disabled/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select id="sex" name="sex" val="${(entity.sex)!}" class="form-control select2" disabled>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div id="faceDiv">
									<img src='${base}${entity.face!}' path='${entity.face!}' width='80px' height='80px' style='margin: 5px 5px 0 0'/>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select id="positionId" name="positionId" val="${(entity.positionId)!}" class="form-control select2" disabled>
									<option value="">请选择</option>
									<#if (configList)?exists && ((configList)?size != 0)>
										<#list configList as config>
											<option value="${config.keyname!}" <#if config.keyname?? && config.keyname==entity.positionId>selected</#if> >${config.val!}</option>
										</#list>
									</#if>
								</select>
							</div>
