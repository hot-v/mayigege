            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                	<div class="tab-pane active" id="tab-content-list">
						<form method="post" id="searchForm" action="${base}/admin/team/index.html" autocomplete="off">
											...
											<#if (pager.entityList)?exists && ((pager.entityList)?size != 0)>
			                                    ...
			                                    <tr>
			                                        ...
			                                        <td>
			                                            ...
			                                            <a href="javascript:void(0)" onclick="return del('${base}/admin/team/delete.json',{id:'${(entity.id)!}'});">删除</a>
			                                        </td>
			                                    </tr>
												</#list>
											<#else>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		$('a[data-toggle="tab"]').on('shown.bs.tab',function(e){
			...
			if(id == ""){
				jumpPage("tab-content-edit","${base}/admin/team/add.html");
			}else{
	 			if(searchType =='2'){
					jumpPage("tab-content-edit","${base}/admin/team/edit.html?id="+id);
				}else{
					jumpPage("tab-content-edit","${base}/admin/team/detail.html?id="+id);
				}
			}
		});
	});
